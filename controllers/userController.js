...
// if (req.files?.primaryPhoto?.length) {
//     console.log("Primary photo received:", req.files.primaryPhoto[0]);

//     user.photos.primaryPhoto =
//         `${baseUrl}/uploads/${req.files.primaryPhoto[0].filename}`;
// }

// if (req.files?.gallery?.length) {
//     console.log("Gallery files received:", req.files.gallery);

//     const newGalleryPaths = req.files.gallery.map(
...
// console.log("Saved Photos Object:", user.photos);
