...
exports.getSentInterests = async (req, res) => {
  try {
    const interests = await Interest.find({
      ...
      .populate("receiverId", "legalName email phone primaryProfilePhoto photoVisibility dob height profession workingWith")
      .sort({ createdAt: -1 });
...
exports.getReceivedInterests = async (req, res) => {
  try {
    const interests = await Interest.find({
      ...
      .populate("senderId", "legalName email phone primaryProfilePhoto photoVisibility dob height profession workingWith")
      .sort({ createdAt: -1 });
...
exports.getFavorites = async (req, res) => {
  try {
    const favorites = await Favorite.find({
      ...
      .populate("favoriteUserId", "legalName email phone primaryProfilePhoto photoVisibility dob height profession workingWith")
      .sort({ createdAt: -1 });
